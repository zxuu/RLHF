# 此代码引用自[https://github.com/wyf3/llm_related/blob/main/train_llm_from_scratch/dpo_train.py]，如需更多信息，请参考[相关文献或链接]。
...
def dpo_loss(ref_probs, probs, beta):
    def split_probs(probs):
        """
        数据处理时把一个batch中好的回答放在一个batch的前面，坏的回答放在batch的后面，
        实际输入模型的batch是实际指定batch的2倍
        """
